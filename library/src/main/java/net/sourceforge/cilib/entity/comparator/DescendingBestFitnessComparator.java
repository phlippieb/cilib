 ...
 */
public class DescendingBestFitnessComparator<E extends Entity> implements Comparator<E>, Serializable {
    ...
    public int compare(E e1, E e2) {
        Fitness f1 = e1.getBestFitness();
        Fitness f2 = e2.getBestFitness();
